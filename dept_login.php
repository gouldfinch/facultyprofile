...
<div id="main">
	<form name="login" action="profile_admin.php" method="post" role="form">
	
	<br> <!--<input type="text" class="form-control" placeholder="Enter Employees ID No." name="emp_id"/>-->
	...
	<a href="index.php">FACULTY LOGIN</a>
	</form>
</div>
</body>
</html>